...
Bienvenue dans la documentation du **Chess Robot**, un projet intégrant un bras robotique UR5e capable de jouer aux échecs de manière autonome contre un joueur humain.
...
│   │   ├── robot_controller.py ← Commandes robot UR5e
...
- **[Robot UR5e](/robot/movements)** — Mouvements, pince, calibration
