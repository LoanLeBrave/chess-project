  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-slate-800 border border-slate-600 rounded-2xl p-6 shadow-2xl max-w-sm w-full mx-4">
        ...
        <div className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg mb-5">
          <div>
            <p className="text-white text-sm font-medium">Replacer les pièces</p>
            <p className="text-slate-400 text-xs">Le robot remettra toutes les pièces en position initiale</p>
          </div>
          <button
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium bg-slate-700 hover:bg-slate-600 text-white transition-colors"
          >
            Annuler
          </button>
          <button
