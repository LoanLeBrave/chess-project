...
OFFSETS = {
    "CAL_TL": {"offset_x": 100, "offset_y": 100},      # +x vers droite, +y vers bas
    "CAL_TR": {"offset_x": -100, "offset_y": 100},     # -x vers gauche, +y vers bas
    "CAL_BL": {"offset_x": 100, "offset_y": -100},     # +x vers droite, -y vers haut
    "CAL_BR": {"offset_x": -100, "offset_y": -100}     # -x vers gauche, -y vers haut
}
