...
class RobotCalibrator:
    ...
    def calibrate(self, max_iterations=50):
        ...
        for iteration in range(max_iterations):
            ...
            # MODE V2: On considère que la calibration est bonne après 1 seul déplacement
            print("\n" + "=" * 60)
            print("✅ CALIBRATION RÉUSSIE (1 itération)")
            print(f"   Position détectée: x={x:.2f}, y={y:.2f}")
